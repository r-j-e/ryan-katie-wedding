  ...
  return (
    <section id="top" style={{
      ...
      <style>{`
        ...
        /* The rest of the hero holds back until the names finish writing (~5.1s) */
        .hero-anim-4{ animation: driftIn 1.4s ease-out 4.95s both; }
        .hero-anim-5{ animation: rise 0.9s ease-out 5.25s both; }
        .hero-anim-6{ animation: rise 0.9s ease-out 5.50s both; }
